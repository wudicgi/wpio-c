 ...
 * 测试流是否支持读取
 *
 * @return bool 若支持读取则返回非 0 值, 否则返回 0
 */
 ...
 * 测试流是否支持写入
 *
 * @return bool 若支持写入则返回非 0 值, 否则返回 0
 */
 ...
 * 测试流是否支持定位
 *
 * @return bool 若支持定位则返回非 0 值, 否则返回 0
 */
 ...
 * 关闭流
 *
 * @return bool 成功时返回 0 (包括 stream 为 NULL 或者未打开), 失败时返回 EOF
 */
 ...
 * 获取指针在流中的位置
 *
 * @return int 返回指针在流中的位置，产生错误时返回 -1
 */
 ...
 * 测试指针是否到了流结束的位置
 *
 * @return bool 如果指针到了流结束的位置则返回非 0 值, 否则返回 0
 */
